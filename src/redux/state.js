...
let appState = {
    friends: {
        friendsItemData : [
            {id:1, name:"Andrew", avatar:"https://whatsism.com/uploads/posts/2018-07/1530546770_rmk_vdjbx10.jpg"},
            {id:2, name:"Leonid", avatar:"https://i.pinimg.com/474x/8d/5c/b8/8d5cb8f030f5c4edfc1785d9d09668ed.jpg"},
            {id:3, name:"Sasha", avatar:"https://proprikol.ru/wp-content/uploads/2020/02/kartinki-na-avatarku-dlya-parnej-i-muzhchin-1-1.jpg"},
            {id:4, name:"Nastya", avatar:"https://lh3.googleusercontent.com/proxy/WM6E7Y4bQdbWHi9cjEt_MCoKscG7GloXQNe05mS3mneePS8a9-JkoQPyQDeIbdEP50fVy0uKic9JujnTULdJT1KTfGEgGkdrQjqTP1AFCtXl8-pnbn6fm1DUxhem43ni9iV5PHSti1x9ZsfTrfdRu3d6"},
    ...
    dialogs: {
        dialogsData: [
            ...
            {id: 2, name: "Dima", text: "Hi",messageData: [
...
export let addPost = () => {
    let newPost = {
        id: appState.profile.postsData.length+1,
        text: appState.profile.newPostText,
        likes : 0
    };
   appState.profile.postsData.push(newPost);
...
export let updateNewMessage = (text) => {
    appState.dialogs.newMessageText = text;
    rerenderEntireTree(appState);
...
export let addMessage = () => {
    debugger;
    let newMessage = {author: "me" , text: appState.dialogs.newMessageText};
    appState.dialogs.dialogsData[0].messageData.push(newMessage);
    rerenderEntireTree(appState);
